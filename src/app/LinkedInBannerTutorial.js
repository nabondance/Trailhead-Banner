  ...
  return (
    <div className='tutorial'>
      ...
      <ol>
        ...
        <li>Go to your profile by clicking on your profile picture or name.</li>
        <li>Click on the pencil icon in the top right corner of your profile header.</li>
        <li>In the Edit Intro pop-up, click on the pencil icon on the banner image.</li>
        ...
        <li>Click "Save" to update your profile with the new banner image.</li>
      </ol>
    </div>
  );
};
