...
const ExamplesPage = () => {
  ...
  const examples = [
    { src: '/assets/examples/example1.png', alt: 'Example 1', description: 'Default Banner Generated' },
    {
      ...
      alt: 'Example 2',
      description: 'Banner with custom background and text color',
    },
    {
      src: '/assets/examples/example3.png',
      alt: 'Example 3',
      description: 'Banner with custom background image from the library',
    },
    {
      src: '/assets/examples/example4.png',
      alt: 'Example 4',
      description: 'Banner with custom background image from the internet',
    },
    { src: '/assets/examples/example5.png', alt: 'Example 5', description: 'Banner without superbadges displayed' },
    {
      ...
      alt: 'Example 6',
      description: 'Banner displaying expired certifications (grey) and retired certifications (faded)',
    },
